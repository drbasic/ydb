...
constexpr ui16 TestBlockCount = 100;
...
Y_UNIT_TEST_SUITE(TDDiskStateTest)
{
    ...
    Y_UNIT_TEST(ShouldMoveRangeFromBehindToAheadOnLateFlush)
    {
        ...
        TDDiskState ddisk(TestBlockCount);
    ...
    {
        TTestBlockFieldMonitor monitor;
        TDDiskState source(TestBlockCount);
        source.Init(
            &monitor,
            /*totalBlockCount=*/100,
        ...
        TDDiskState target(TestBlockCount);
        target.Init(
            &monitor2,
            /*totalBlockCount=*/100,
            /*operationalBlockCount=*/5);
        ...
        TDDiskState empty(TestBlockCount);
        empty.Init(
            &monitor3,
            /*totalBlockCount=*/100,
        ...
        TDDiskState loaded(TestBlockCount);
        loaded.Init(
            &monitor4,
            /*totalBlockCount=*/100,
            /*operationalBlockCount=*/100);
    ...
    {
        TBlockRangeField ahead(TestBlockCount);
        ahead.Add(TBlockRange16::WithLength(50, 10));

        TBlockRangeField behind(TestBlockCount);
