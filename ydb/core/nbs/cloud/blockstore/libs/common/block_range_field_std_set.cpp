...
TBlockRangeFieldStdSet::TBlockRangeFieldStdSet(ui16 maxBlockCount)
...
ui16 TBlockRangeFieldStdSet::GetBlockCount() const
{
    size_t total = 0;
    for (const auto& range: Intervals) {
        total += range.Size();
...
TString TBlockRangeFieldStdSet::Print() const
{
